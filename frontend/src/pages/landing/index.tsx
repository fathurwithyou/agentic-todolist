...
import { ArrowRight, Calendar, Check, ChevronRight, Clock, Globe, Sparkles, Users, Shield, FileText, Bot } from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Navbar loginAction={redirectToLogin} />
      <main>
        <HeroSection loginAction={redirectToLogin} />
        <FeaturesSection />
        <TestimonialsSection />
      </main>
      <Footer />
...
const Navbar = ({ loginAction }: { loginAction: () => void }) => {
  ...
  return (
    <header className={cn("px-2 fixed top-0 left-0 right-0 z-50 transition-all duration-300", isScrolled ? "py-2" : "py-4")}>
      <nav
        className={cn(
          "mx-auto transition-all duration-300",
          isScrolled
            ? "max-w-4xl px-2 bg-background/95 backdrop-blur-xl border border-border rounded-2xl shadow-soft"
            : "container-width"
        )}>
        <div className="flex h-14 items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="px-1 font-semibold text-lg">CalendarAI</span>
          </div>
...
const TextToCalendarDemo = () => {
  ...
  return (
    <div className="relative px-2">
      {/* Connection Line - Horizontal for desktop only */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 hidden lg:block">
      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-32">
        {/* Text Input Side */}
        <div className={cn("transition-all duration-500", activeStep === 0 ? "scale-105 opacity-100" : "scale-100 opacity-70")}>
          <div className="mb-4">
          ...
          <Card className="overflow-hidden border-2 border-border/50 shadow-xl">
            ...
            <div className="p-6 font-mono text-sm space-y-3">
              <p className={cn("transition-all duration-500", activeStep >= 1 ? "text-primary" : "text-muted-foreground")}>
              ...
              <p className="text-muted-foreground pt-2">
                <span className="text-purple-600">Meetings:</span>
                <br />
        ...
        <div className="relative lg:hidden">
          <div className="flex justify-center lg:hidden relative">
            {/* Line */}
            <div className="relative h-32 w-[2px] bg-gradient-to-b from-transparent via-primary/20 to-transparent">
              <div
                className="absolute left-0 w-full bg-gradient-to-b from-transparent via-primary to-transparent transition-all duration-1000"
                style={{
        ...
        <div className={cn("transition-all duration-500", activeStep === 2 ? "scale-105 opacity-100" : "scale-100 opacity-70")}>
          <div className="mb-4">
          ...
          <Card className="overflow-hidden border-2 border-border/50 shadow-xl">
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="space-y-2">
                <CalendarEvent date="July 1-10" title="Submit proposal" color="bg-blue-500" show={activeStep === 2} delay={0} />
                <CalendarEvent
        ...
        {[0, 1, 2].map((step) => (
          <button
            ...
            className={cn(
              ...
              activeStep === step ? "w-8 bg-primary" : "bg-primary/20 hover:bg-primary/30"
            )}
          />
        ))}
      </div>
...
const CalendarEvent = ({
  ...
  >
    <div className={cn("w-1 h-12 rounded-full shrink-0", color)} aria-hidden="true" />
    ...
    <div className="flex items-center gap-1" aria-label="Attendees">
